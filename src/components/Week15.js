...
/**
 * Week 15 — Celebrate Milestones
 * - Autosaves to localStorage (key: "week15-notes")
 * - Weekly check-in + achievements section
 * - Daily journaling + gratitude + visualization + affirmations
 */

export default function Week15() {
  const STORAGE_KEY = "week15-notes";
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: 16 }}>
      <h1>Welcome to Week 15!</h1>
      <p>Reinforce progress and celebrate milestones you’ve achieved.</p>
      ...
      <label>List your wins or milestones this week (no matter how small).</label>
      <textarea
        style={taLong}
        placeholder="Describe your achievements..."
        value={data.weeklyWins}
        onChange={e=>setField(["weeklyWins"], e.target.value)}
      />

      <div style={card}>
        <p><strong>The Importance of Acknowledging Milestones</strong></p>
        <ul>
          <li><strong>Reinforces Positive Behavior:</strong> Recognizing achievements makes you more likely to continue.</li>
          <li><strong>Boosts Confidence:</strong> Each milestone builds self-belief.</li>
          <li><strong>Maintains Momentum:</strong> Celebrating progress sustains motivation.</li>
          <li><strong>Increases Enjoyment:</strong> Successes make the journey more fulfilling.</li>
        </ul>
      </div>
